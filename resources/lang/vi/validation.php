...
return array (
  ...
  array (
    ...
    'email' => 'e-mail',
    'banned_at' => 'cấm',
    'avatar_img' => 'hình đại điện',
    'cover_img' => 'ảnh bìa',
    'deleted_at' => 'ngày xóa',
    'created_at' => 'ngày tạo',
    'updated_at' => 'ngày cập nhật',
    'user_links' => 'liên kết người dùng',
    'roles' => 'vai trò người dùng',
    'user_config' => 'thiết lập người dùng',
    'link' => 'liên kết',
    'title' => 'tiêu đề',
    'app_language' => 'ngôn ngữ ứng dụng',
    'user_language' => 'ngôn ngữ người dùng',
    'display_name_style' => 'loại tên hiển thị',
    'img' => 'hình ảnh',
    'name' => 'tên',
    'slug' => 'tên phụ',
    'token' => 'mã thông báo',
    'descriptions' => 'mô tả',
    'unit_price' => 'đơn giá',
    'feature_img' => 'hình ảnh đặc trưng',
    'gallery' => 'bộ sưu tập',
    'body' => 'nội dung',
    'status' => 'trạng thái',
    ...
    'product_uuid' => 'id sẩm phẩm',
    'increment_quantity' => 'tăng số lượng',
    'user_uuid' => 'id người dùng',
    'user_link_uuid' => 'id liên kết người dùng',
    'subject' => 'tiêu đề',
    'files' => 'tập tin',
    'from_email' => 'địa chỉ e-mail',
    'contact_topic_uuid' => 'id chủ để',
  ),
);
