...
//            Cache::flush();
            ...
            if (!isset($user->userApp->app_uuid) && !isset($user->userAddOns) && !isset($user->userTeam->permission_uuids)) {
                return false;
            }
            //check team leader
