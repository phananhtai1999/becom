        ...
        $validate =  [
            ...
            'forms.*' => ['numeric', 'min:1', Rule::exists('forms', 'uuid')->where(function ($query) {
                ...
                return $query->where([
                    ...
                    ['publish_status', '<>', Form::DRAFT_PUBLISH_STATUS]
                ])->whereNull('deleted_at');
            })],
            'publish_status' => ['required', 'numeric', Rule::in(Form::PUBLISHED_PUBLISH_STATUS, Form::REJECT_PUBLISH_STATUS, Form::PENDING_PUBLISH_STATUS, Form::DRAFT_PUBLISH_STATUS)]
        ];
